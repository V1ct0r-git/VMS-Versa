...
(2,'Renault',2023,'Premium 400','X740XC42','VF1J1AQML1FKCM10J','04932DJ11614','White',400,'2025-11-17','2026-11-17',8000,'Новый аккумулятор',NULL,'Active'),
...
(26,'DAF',2021,'XF 460','Y385OO42','XLRC8PIPHMR0MNHKE','PSB1149HD570','Silver',460,'2025-09-20','2025-11-09',10000,'Замена масла',105210,'Inactive'),
(27,'тест',2025,'Тест','я','12345678901284657','23414414','red',111,NULL,NULL,10000,NULL,0,'Active');
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Обслуживание';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(25,2,1,'medium',2,'2025-11-14','2025-11-17','Запланированное плановое ТО. Замена масла, фильтров, диагностика.',NULL,NULL,NULL,NULL,'2026-11-17',0,'completed'),
...
(51,24,3,'low',2,'2025-11-20',NULL,'',5000.00,1000.00,6000.00,208326,NULL,0,'planned'),
(52,4,1,'medium',2,'2025-12-18','2025-12-24','',15000.00,2000.00,17000.00,210898,NULL,0,'cancelled'),
(53,25,8,'low',2,'2026-06-15',NULL,'',5000.00,500.00,5500.00,260261,NULL,0,'planned'),
(54,24,3,'low',3,'2026-06-17',NULL,'',5000.00,1000.00,6000.00,208326,NULL,0,'planned');
...
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Напоминания';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'low','2025-10-31 07:04:23',1,'2025-07-10','Напоминание: Замена масла и фильтров запланирована на 10 июня 2023','true'),
(2,'medium','2025-10-31 07:04:23',2,'2025-09-24','Напоминание: Техническое обслуживание запланировано на 15 июля 2023','false'),
(3,'high','2025-10-31 07:04:23',3,'2025-09-08','Напоминание: Ремонт тормозной системы запланирован на 3 августа 2023','false'),
(4,'medium','2025-10-31 07:04:23',4,'2025-08-05','Напоминание: Замена шин запланирована на 12 сентября 2023','true'),
(5,'low','2025-10-31 07:04:23',5,'2025-09-22','Напоминание: Диагностика двигателя запланирована на 20 октября 2023','true'),
(6,'critical','2025-10-31 07:04:23',6,'2025-09-25','Напоминание: Замена ремня ГРМ запланирована на 5 ноября 2023','false'),
(7,'medium','2025-10-31 07:04:23',7,'2025-10-21','Напоминание: Ремонт коробки передач запланирован на 10 декабря 2023','true'),
(8,'low','2025-10-31 07:04:23',8,'2025-08-01','Напоминание: Плановое ТО запланировано на 15 января 2024','false'),
(9,'medium','2025-10-31 07:04:23',9,'2025-09-15','Напоминание: Замена радиатора запланирована на 1 февраля 2024','true'),
(10,'high','2025-10-31 07:04:23',10,'2025-11-06','Напоминание: Ремонт подвески запланирован на 10 февраля 2024','false'),
(11,'medium','2025-10-31 07:04:23',11,'2025-10-19','Напоминание: Замена топливного фильтра запланирована на 5 марта 2024','true'),
(12,'critical','2025-10-31 07:04:23',12,'2025-11-07','Напоминание: Капитальный ремонт двигателя запланирован на 18 марта 2024','true'),
(13,'medium','2025-10-31 07:04:23',13,'2025-09-24','Напоминание: Проверка электрики запланирована на 1 апреля 2024','true'),
(14,'low','2025-10-31 07:04:23',14,'2025-07-30','Напоминание: Замена воздушного фильтра запланирована на 10 апреля 2024','true'),
(15,'medium','2025-10-31 07:04:23',15,'2025-10-31','Напоминание: Ремонт выхлопной системы запланирован на 5 мая 2024','false'),
(16,'medium','2025-10-31 07:04:23',16,'2025-09-16','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-09-26 для Renault Premium 400 (Y966HE42).','false'),
(17,'medium','2025-10-31 07:04:23',25,'2025-11-04','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-11-14 для Renault Premium 400 (X740XC42).','false'),
(18,'medium','2025-10-31 07:04:23',26,'2025-11-08','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-11-18 для Scania G410 (M043CK142).','false'),
(19,'medium','2025-10-31 07:04:23',28,'2025-11-25','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-12-05 для Renault Premium 420 (H774KP42).','false'),
(20,'medium','2025-10-31 07:04:23',30,'2025-12-04','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-12-14 для Renault Premium 400 (E234TB42).','false'),
(21,'medium','2025-10-31 07:04:23',31,'2025-12-21','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-12-31 для Renault Premium 420 (T753EK42).','false'),
(22,'medium','2025-10-31 07:04:23',32,'2025-10-16','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-10-26 для Iveco Stralis 440 (H701OK42).','false'),
(23,'medium','2025-10-31 07:04:23',33,'2025-11-30','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-12-10 для Iveco Stralis 480 (X819BT142).','true'),
(24,'medium','2025-10-31 07:04:23',35,'2026-01-03','Напоминание: ТО \"Плановое ТО\" запланировано на 2026-01-13 для Iveco Stralis 440 (C156BA142).','false'),
(25,'medium','2025-10-31 07:04:23',36,'2025-12-28','Напоминание: ТО \"Плановое ТО\" запланировано на 2026-01-07 для Iveco Stralis 440 (H978AC42).','false'),
(26,'medium','2025-10-31 07:04:23',37,'2025-11-14','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-11-24 для Iveco Stralis 440 (H385KA142).','false'),
(27,'medium','2025-10-31 07:04:23',38,'2025-09-29','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-10-09 для Volvo FH16 500 (M653CC42).','false'),
(28,'medium','2025-10-31 07:04:23',39,'2026-03-02','Напоминание: ТО \"Плановое ТО\" запланировано на 2026-03-12 для Volvo FM 420 (X479KP42).','false'),
(29,'medium','2025-10-31 07:04:23',40,'2025-12-21','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-12-31 для Renault Premium 400 (C674KO142).','false'),
(30,'medium','2025-10-31 07:04:23',42,'2025-09-20','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-09-30 для Renault Premium 420 (A296CB42).','false'),
(31,'medium','2025-10-31 07:04:23',43,'2025-10-20','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-10-30 для MAN TGX 18.500 (O503KA142).','false'),
(32,'medium','2025-10-31 07:04:23',44,'2025-10-30','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-11-09 для DAF XF 460 (Y385OO42).','false'),
(33,'low','2025-10-31 07:04:23',48,'2025-10-31','Напоминание: ТО \"Плановое ТО\" запланировано на 2025-11-10 для КАМАЗ 6520 (T940OO142).','false'),
(34,'medium','2025-10-31 07:04:23',19,'2025-09-09','Напоминание: ТО \"Замена масла\" запланировано на 2025-09-19 для DAF XF 460 (Y385OO42).','false'),
(35,'medium','2025-10-31 07:04:23',34,'2026-01-21','Напоминание: ТО \"Замена масла\" запланировано на 2026-01-31 для Iveco Stralis 440 (T046CA42).','false'),
(36,'medium','2025-10-31 07:04:23',41,'2025-11-06','Напоминание: ТО \"Замена масла\" запланировано на 2025-11-16 для Renault Premium 400 (Y966HE42).','false'),
(37,'low','2025-10-31 07:04:23',49,'2025-11-21','Напоминание: ТО \"Замена масла\" запланировано на 2025-12-01 для DAF XF 460 (X887EO142).','false'),
(38,'high','2025-10-31 07:04:23',20,'2025-12-31','Напоминание: ТО \"Диагностика\" запланировано на 2026-01-10 для Volvo FM 420 (X479KP42).','false'),
(39,'critical','2025-10-31 07:04:23',22,'2025-09-03','Напоминание: ТО \"Диагностика\" запланировано на 2025-09-13 для MAN TGS 33.440 (X456CT142).','false'),
(40,'high','2025-10-31 07:04:23',23,'2025-09-04','Напоминание: ТО \"Диагностика\" запланировано на 2025-09-14 для Iveco Stralis 480 (C767TH42).','false'),
(41,'high','2025-10-31 07:04:23',24,'2025-09-02','Напоминание: ТО \"Диагностика\" запланировано на 2025-09-12 для Volvo FH16 500 (K083CY42).','false'),
(42,'low','2025-10-31 07:04:23',50,'2025-09-30','Напоминание: ТО \"Диагностика\" запланировано на 2025-10-10 для Renault Premium 400 (C759PT142).','false'),
(43,'high','2025-10-31 07:04:23',21,'2025-09-04','Напоминание: ТО \"Замена тормозных колодок\" запланировано на 2025-09-14 для Renault Premium 400 (H629CE142).','true'),
(44,'medium','2025-10-31 07:04:23',27,'2025-10-05','Напоминание: ТО \"Замена тормозных колодок\" запланировано на 2025-10-15 для Scania R500 (P959KP42).','false'),
(45,'medium','2025-10-31 07:04:23',29,'2025-11-16','Напоминание: ТО \"Замена тормозных колодок\" запланировано на 2025-11-26 для Renault Premium 400 (C759PT142).','false'),
(46,'high','2025-10-31 07:04:23',45,'2025-09-10','Напоминание: ТО \"Замена ремня ГРМ\" запланировано на 2025-09-20 для MAN TGS 33.440 (X456CT142).','false'),
(47,'critical','2025-10-31 07:04:23',47,'2025-09-05','Напоминание: ТО \"Замена ремня ГРМ\" запланировано на 2025-09-15 для Volvo FH16 500 (K083CY42).','false'),
(48,'medium','2025-10-31 07:04:23',46,'2025-09-06','Напоминание: ТО \"Замена свечей зажигания\" запланировано на 2025-09-16 для Iveco Stralis 480 (C767TH42).','false'),
(49,'low','2025-10-31 07:04:23',17,'2025-07-31','Напоминание: ТО \"Проверка подвески\" запланировано на 2025-08-10 для Renault Premium 420 (A296CB42).','false'),
(50,'medium','2025-10-31 07:04:23',18,'2025-08-05','Напоминание: ТО \"Проверка подвески\" запланировано на 2025-08-15 для MAN TGX 18.500 (O503KA142).','false'),
(79,'low','2025-11-16 09:31:33',51,'2025-11-19','ТО \'Диагностика\' для КАМАЗ 6520 (T940OO142) запланировано на 20.11.2025, приоритет: low','false'),
(80,'low','2026-06-15 09:04:01',53,'2026-06-16','ТО \'Замена аккумулятора\' для MAN TGX 18.500 (O503KA142) запланировано на 15.06.2026, приоритет: low','false'),
(81,'low','2026-06-16 04:42:28',54,'2026-06-17','ТО \'Диагностика\' для КАМАЗ 6520 (T940OO142) запланировано на 17.06.2026, приоритет: low','false');
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Ремонт';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(3,'engine','high','in_progress',NULL,15,'2025-09-15','Перегрев двигателя','Замена радиатора и термостата',28000.00,'Автохолод'),
...
(27,'engine','medium','planned','2025-12-24',1,'2025-12-17','Плановый осмотр','Диагностика двигателя и замена масла',7500.00,'Автоцентр'),
(28,'transmission','medium','completed','2026-05-29',4,'2026-04-28','Естественный износ','',6400.00,'Замена тормозных шлангов');
...
CREATE TABLE `Users` (
  ...
  `passwordHash` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'Пароль',
...
(1,'shlegel_v','$2b$12$xv0r8GJxTX.4yR70zFkNBOQd.FoxmDX0it7qm3YfAxZp2a6i3iLXe','Шлегель Виктор Алексеевич','shlegelza14@gmail.com',NULL,'admin','2026-06-16 13:33:15','false',0,NULL,NULL),
(2,'ivanov_p','$2b$12$Rp8op5yD9j38w1tOKFNakOg4pdUGZRb4oJ2Hpq8dNXzXhZj87MNIO','Иванов Пётр Сергеевич','p.ivanov@example.ru',NULL,'mechanic','2026-05-21 11:45:52','false',0,NULL,NULL),
(3,'sidorov_a','$2b$12$qpqFbVs5GLliU19ETfIL5uGJ37fY80uTglf92vB.aAsIb19Lxkh7S','Сидоров Алексей Владимирович','a.sidorov@example.ru',NULL,'mechanic','2026-06-16 13:39:28','false',0,NULL,NULL),
...
(5,'kozlov_d','5f4dcc3b5aa765d61d8327deb882cf99','Козлов Дмитрий Николаевич','d.kozlov@example.ru',NULL,'mechanic','2025-09-15 00:00:00','false',0,NULL,NULL),
(6,'smirnova_o','$2b$12$bFDom2xxNKQysLIdfiUA0Oln.OPzoyUbUuNSPChycahtynaO9uWci','Смирнова Ольга Викторовна','o.smirnova@example.ru',NULL,'manager','2026-06-16 13:40:49','false',0,NULL,NULL),
(7,'popova_e','$2b$12$h2f2OY8is8DM5EXxBhT7p.7HoiXZ6v819vRKZxCgQdIb.DhJ7w1H6','Попова Екатерина Александровна','e.popova@example.ru',NULL,'manager','2026-05-21 11:46:23','false',0,NULL,NULL),
(9,'salomatin_i','b3877fcd2835e5d895112ca880eafa26','Саломатин Игорь Петрович','i.salomatin@example.ru',NULL,'admin','2025-12-08 12:18:19','false',0,NULL,NULL);
...
-- Dump completed on 2026-06-17 11:46:34
