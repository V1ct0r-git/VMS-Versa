...
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Обслуживание';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(53,25,8,'low',2,'2026-06-15','2026-06-16','',5000.00,500.00,5500.00,260261,NULL,0,'planned');
...
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Напоминания';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'admin','$2b$12$z4Oo0PELCWAmCKCTWSDtIekftAVzCfgk0WQyJPEyQ2aRIz/EMHbFe','Шлегель Виктор Алексеевич','shlegelza14@gmail.com',NULL,'admin','2026-05-21 11:45:11','false',0,NULL,NULL),
...
(6,'smirnova_o','777a9cc4a183bca929313b477a8b69b7','Смирнова Ольга Викторовна','o.smirnova@example.ru',NULL,'manager','2025-09-15 00:00:00','false',0,NULL,NULL),
...
(9,'salomatin_r','b3877fcd2835e5d895112ca880eafa26','Саломатин Игорь Петрович','i.salomatin@example.ru',NULL,'admin','2025-12-08 12:18:19','false',0,NULL,NULL);
...
-- Dump completed on 2026-06-16 11:15:39
